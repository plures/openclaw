...
if (-not $head.StartsWith("2ace157", [System.StringComparison]::OrdinalIgnoreCase)) {
    throw "Expected HEAD beginning with 2ace157; current HEAD is $head. Regenerate this patch for the current commit."
}
